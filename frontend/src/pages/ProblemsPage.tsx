            ...
            {expanded === problem.id && (
              <div className="px-4 pb-4 border-t border-gray-700/50 space-y-3 pt-3">
                ...
                {problem.examples.length > 0 && (
                  <div className="space-y-2">
                    <span className="text-xs font-semibold text-white">Examples:</span>
                    {problem.examples.map((ex, i) => (
                      <div key={i} className="rounded bg-black/30 border border-gray-700 px-3 py-2 font-mono text-xs space-y-0.5">
